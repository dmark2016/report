...
is a paper on strided and sequential prefetching.
The authors find that sequential prefetching in some cases performs better than strided prefetching.
They argue that a significant amount of the strides were shorter than the block size.
