...
\todo{Split into two sections: "Global History Buffer" and "Delta Correlation"}
% Splitting is important because both SDP and RPT can be implemeted using GHB
% (although it makes the implementation unnecessary complex).
